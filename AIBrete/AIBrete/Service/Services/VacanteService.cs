...
namespace AIBrete.Service.Services
{
    public class VacanteService : IVacanteService
    {
        ...
        public VacanteService(HttpClient httpClient, IOptions<ConfigurationOptions> configOptions)
        {
        ...
        public async Task<IEnumerable<Vacante>> GetVacantes(
            string searchTerm, int minCompatibilidad, bool ascendente)
        {
